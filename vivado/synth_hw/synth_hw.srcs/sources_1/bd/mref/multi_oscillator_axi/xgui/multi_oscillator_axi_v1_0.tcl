...
proc update_PARAM_VALUE.FREQ_MULT_PARAM_BITS { PARAM_VALUE.FREQ_MULT_PARAM_BITS } {
	# Procedure called to update FREQ_MULT_PARAM_BITS when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.FREQ_MULT_PARAM_BITS { PARAM_VALUE.FREQ_MULT_PARAM_BITS } {
	# Procedure called to validate FREQ_MULT_PARAM_BITS
	return true
}
...
proc update_MODELPARAM_VALUE.FREQ_MULT_PARAM_BITS { MODELPARAM_VALUE.FREQ_MULT_PARAM_BITS PARAM_VALUE.FREQ_MULT_PARAM_BITS } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.FREQ_MULT_PARAM_BITS}] ${MODELPARAM_VALUE.FREQ_MULT_PARAM_BITS}
}
